...
const Validator = {
    ...
    reset_forget_password: async (req, res, next) => {
        if (
            checkEmpty(req.body, ["authtoken", "password", "confirm_password"])
        ) {
            const schema = Joi.object().keys({
                ...
                password: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid password required.(Length 8 to 15 words)"
                        );
                    }),
            ...
            try {
                ...
                if (result.error) {
                    ...
                    let check_authtoken = await helpers.get_token_check({
    ...
    register: async (req, res, next) => {
        const schema = Joi.object().keys({
            ...
            password: Joi.string()
                ...
                .messages({
                    "string.pattern.base":
                        "Password can contain at least 8 characters long,one lowercase, one uppercase, one number and one special character,no whitespaces,",
        ...
        try {
            ...
            if (result.error) {
                ...
                if (error1 == "" && !username_exist) {
                    ...
                    if (error1) {
                        res.status(StatusCode.badRequest).send(
                            ServerResponse.validationResponse(error1)
                        );
                    } else {
                        res.status(StatusCode.badRequest).send(
                            ServerResponse.validationResponse(
            ...
            const schema = Joi.object().keys({
                ...
                username: Joi.string()
                    ...
                    .messages({
                        ...
                        "string.min": "Username minimum length is 5 characters",
                        "string.max":
                            "Username maximum length is 29 characters",
                    }),
                password: Joi.string()
                    .min(8)
                    .max(15)
        ...
        if (checkEmpty(req.body, ["currency", "code"])) {
            const schema = Joi.object().keys({
                currency: Joi.string()
                    ...
                    .messages({
                        "string.pattern.base":
                            "Currency can contain only alphabets",
                        ...
                        "string.max":
                            "Currency maximum length is 100 characters",
                    }),
                code: Joi.string()
        ...
        if (checkEmpty(req.body, ["type_of_business"])) {
            const schema = Joi.object().keys({
                type_of_business: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid type of business name required"
                        );
                    }),
            });
                ...
                if (result.error) {
                    ...
                    if (!record_exist) {
                        ...
                        res.status(StatusCode.badRequest).send(
                            ServerResponse.validationResponse(
                                record_exist
                                    ? "Merchant category already exist."
                                    : ""
                            )
                        );
                    }
        ...
        if (
            ...
            const schema = Joi.object().keys({
                ...
                zero_at_first_place: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid Zero at the first place required"
                        );
                    }),
        ...
        if (checkEmpty(req.body, ["city_name", "state_id", "country_id"])) {
            ...
            try {
                ...
                if (result.error) {
                    ...
                    let state_id = enc_dec.cjs_decrypt(
        ...
        if (
            ...
            const schema = Joi.object().keys({
                ...
                username: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid username required (Length 5 to 15 words)"
                        );
                    }),
                password: Joi.string()
                    .min(8)
        ...
        if (
            ...
            const schema = Joi.object().keys({
                ...
                logout_time: Joi.number()
                    ...
                    .error(() => {
                        return new Error(
                            "Idle logout timeout should be 15-120"
                        );
                    }),
        ...
        if (
            ...
            const schema = Joi.object().keys({
                ...
                api_key: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid API key required (length: 8-30 char.)"
                        );
                    }),
        ...
        if (checkEmpty(req.body, ["merchant_id"])) {
            ...
            try {
                ...
                if (result.error) {
                    ...
                    let rec_id = enc_dec.cjs_decrypt(
        ...
        if (
            ...
            const schema = Joi.object().keys({
                ...
                use_logo_instead_icon: Joi.number()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid use logo instead of icon required"
                        );
                    }),
                language: Joi.string()
                    .min(1)
                    ...
                    let data_exist = await checkifrecordexist(
                        {
                            ...
                            psp_id: enc_dec.cjs_decrypt(
                                req.bodyString("psp_id")
                            ),
                            cureency_id: enc_dec.cjs_decrypt(
                                req.bodyString("cureency_id")
                            ),
    ...
    submerchant_update: async (req, res, next) => {
        if (
            checkEmpty(req.body, ["id", "merchant_id", "legal_business_name"])
        ) {
            const schema = Joi.object().keys({
                id: Joi.string()
                    .min(2)
    ...
    mcc_update: async (req, res, next) => {
        if (
            checkEmpty(req.body, ["mcc_id", "mcc", "category", "description"])
        ) {
            const schema = Joi.object().keys({
                mcc_id: Joi.string()
                    .min(2)
        ...
        try {
            ...
            if (result.error) {
                ...
                if (record_exist) {
                    ...
                    res.status(StatusCode.badRequest).send(
                        ServerResponse.validationResponse("Invalid token.")
                    );
                }
            }
        } catch (error) {
        ...
        try {
            ...
            if (result.error) {
                ...
                if (record_exist) {
                    ...
                    res.status(StatusCode.badRequest).send(
                        ServerResponse.validationResponse("Customer not found")
                    );
                }
            }
        } catch (error) {
        ...
        if (checkEmpty(req.body, ["tc_id"])) {
            const schema = Joi.object().keys({
                tc_id: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Terms and conditions source required"
                        );
                    }),
            });
        ...
        if (checkEmpty(req.body, ["tc_id", "tc", "version"])) {
            const schema = Joi.object().keys({
                tc_id: Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "Valid terms and condition source required"
                        );
                    }),
                tc: Joi.string()
                    .min(2)
    ...
    fraud_detection_update: async (req, res, next) => {
        const schema = Joi.object().keys({
            suspicious_emails: Joi.array().items(
                Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "should be in proper csv format and valid emails"
                        );
                    })
            ),
            suspicious_ips: Joi.array().items(
                Joi.string()
                    ...
                    .error(() => {
                        return new Error(
                            "should be in proper csv format and valid ip"
                        );
                    })
            ),
        });
        ...
        try {
            ...
            let custom_body = {
                suspicious_emails: emails.split(","),
                suspicious_ips: ips.split(","),
            };
