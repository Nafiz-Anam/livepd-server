...
<div class="qr_div_main" style="margin-top:5%">
  <div class="wrap" style="border: 4px solid white;border-radius: 10px;margin: 10px;padding: 10px;">
      <div class="qr_div" style="width: 80%;">
        <img class="merchant-logo" src="${data.merchant_logo}" alt="logo" >
            <h2 class="accept_title m-a-10" >Scan and Pay</h2>
            <img class="qr_image" src="${data.qr_image}" style="height: 250px;" alt="QR image">
    ...
    <td>
    <a href="${data.pay_url}"
    style="font-weight: 600;margin-left:170px; font-size: 14px; line-height: 100%; --text-opacity: 1;  color: rgba(255, 255, 255, var(--text-opacity));border-radius:3px; text-decoration: none;padding: 0.8em 30px;border: 1px solid #ccc;background-color:#7367f0 ;">Click here to pay </a>
    </td>
    </tr>
    <tr>
    <td>
    <p class="sm-leading-32"
    style="font-weight: 600; font-size: 20px; margin: 0 0 30px; --text-opacity: 1; color: #263238; color: rgba(38, 50, 56, var(--text-opacity));">
